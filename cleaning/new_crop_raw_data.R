...
#' as the raw data.
#' @param cropped_loc File path to the new directory where cropped data files will
...
#'
new_crop_raw_data = function(rawdata_loc, ldrtimes_fn, cropped_loc, nfiles = NULL){ #, croppedplots_loc){
  cropped_loc = paste0(cropped_loc, "/")
  croppedplots_loc = paste0(cropped_loc, "cropped_plots/")
